...
export class Migrations1775249807236 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "isFeatured" boolean NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "isOnSale" boolean NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "titleEn" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "titleFi" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "infoEn" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchasable" ADD "infoFi" character varying NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "purchasable" DROP COLUMN "isFeatured"`,
    );
  }
}
